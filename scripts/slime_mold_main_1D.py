...
results_folder = '../results/2020_sweep_longer_time_polynomial'# parameter_sweep_0420/polynomial_kernal/'
filename = '/2020_sweep_longer_time_polynomial'#'0420sweep_polynomial_kernal'
