...
def plot_six_profiles(x_label, y_label, sol_dict_path, param_dict_path, plot_number, title, params = None):
...
sol = gaussian_solutions[(1,10,10)]

output = plot_both_things(sol, gaussian_params['M'], compute_even_plot_times(len(sol['t']), 5), gaussian_params['cell_start'], gaussian_params['cell_end'], gaussian_params['eps'], gaussian_params['y0'], gaussian_params['y1'], 100,'test')

# %%
gaussian_drift = plot_four_profiles('position', 'density', '../results/2020_sweep_gaussian_kernel/2020_sweep_gaussian_kernel_solution_data.pkl', '../results/2020_sweep_gaussian_kernel/2020_sweep_gaussian_kernel_param_dict.pkl', 5, "Drift dominated regime - gaussian kernel", 'drift')
gaussian_drift.savefig('../../tex/drafts/figures/gaussian_drift_dominated_2020_200.pdf', format = 'pdf')

# %%
gaussian_interaction = plot_four_profiles('position', 'density', '../results/2020_sweep_gaussian_kernel/2020_sweep_gaussian_kernel_solution_data.pkl', '../results/2020_sweep_gaussian_kernel/2020_sweep_gaussian_kernel_param_dict.pkl', 5, "Interaction dominated regime - gaussian kernel", 'interaction')
...
# %%
gaussian_fullcompetition = plot_six_profiles('position', 'density', '../results/2020_sweep_gaussian_kernel/2020_sweep_gaussian_kernel_solution_data.pkl', '../results/2020_sweep_gaussian_kernel/2020_sweep_gaussian_kernel_param_dict.pkl', 5, "Competition regime - gaussian kernel", params = [(10,10,1), (10,10,5), (10,1,10), (10,5,10),(1,10,10), (5,10,10)])
gaussian_fullcompetition.savefig('../../tex/drafts/figures/gaussian_fullcompetition_2020_200.pdf', format = 'pdf')

# %%
quad_drift = plot_four_profiles('position', 'density', '../results/2020_sweep_quadratic_kernel/2020_sweep_quadratic_kernel_solution_data.pkl', '../results/2020_sweep_quadratic_kernel/2020_sweep_quadratic_kernel_param_dict.pkl', 5, "Drift dominated regime - quadratic kernel", 'drift')
quad_drift.savefig('../../tex/drafts/figures/quadratic_drift_dominated_2020_200.pdf', format = 'pdf')

# %%
quad_interaction = plot_four_profiles('position', 'density', '../results/2020_sweep_quadratic_kernel/2020_sweep_quadratic_kernel_solution_data.pkl', '../results/2020_sweep_quadratic_kernel/2020_sweep_quadratic_kernel_param_dict.pkl', 5, "Interaction dominated regime - quadratic kernel", 'interaction')
...
# %%
quad_fullcompetition = plot_six_profiles('position', 'density', '../results/2020_sweep_quadratic_kernel/2020_sweep_quadratic_kernel_solution_data.pkl', '../results/2020_sweep_quadratic_kernel/2020_sweep_quadratic_kernel_param_dict.pkl', 5, "Competition regime - quadratic kernel", params = [(10,10,1), (10,10,5), (10,1,10), (10,5,10),(1,10,10), (5,10,10)])
quad_fullcompetition.savefig('../../tex/drafts/figures/quadratic_fullcompetition_2020_200.pdf', format = 'pdf')

# %%
poly_drift = plot_four_profiles('position', 'density', '../results/2020_sweep_polynomial_kernel/2020_sweep_polynomial_kernel_solution_data.pkl', '../results/2020_sweep_polynomial_kernel/2020_sweep_polynomial_kernel_param_dict.pkl', 5, "Drift dominated regime - polynomial kernel", 'drift')
poly_drift.savefig('../../tex/drafts/figures/polynomial_drift_dominated_2020_200.pdf', format = 'pdf')

# %%
poly_interaction = plot_four_profiles('position', 'density', '../results/2020_sweep_polynomial_kernel/2020_sweep_polynomial_kernel_solution_data.pkl', '../results/2020_sweep_polynomial_kernel/2020_sweep_polynomial_kernel_param_dict.pkl', 5, "Interaction dominated regime - polynomial kernel", 'interaction')
...
#%%
poly_fullcompetition = plot_six_profiles('position', 'density', '../results/2020_sweep_polynomial_kernel/2020_sweep_polynomial_kernel_solution_data.pkl', '../results/2020_sweep_polynomial_kernel/2020_sweep_polynomial_kernel_param_dict.pkl', 5, "Competition regime - polynomial kernel", params = [(10,10,1), (10,10,5), (10,1,10), (10,5,10),(1,10,10), (5,10,10)])
gaussian_fullcompetition.savefig('../../tex/drafts/figures/polynomial_fullcompetition_2020_200.pdf', format = 'pdf')
